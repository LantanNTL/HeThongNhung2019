...
/*---------------reg set priority--------------*/
#define NVIC_IPR0					(*(volatile unsigned long *)(0xE000E400u))
#define NVIC_IPR1					(*(volatile unsigned long *)(0xE000E404u))
#define NVIC_IPR2					(*(volatile unsigned long *)(0xE000E408u))
#define NVIC_IPR3					(*(volatile unsigned long *)(0xE000E40Cu))
#define NVIC_IPR4					(*(volatile unsigned long *)(0xE000E410u))
#define NVIC_IPR5					(*(volatile unsigned long *)(0xE000E414u))
#define NVIC_IPR6					(*(volatile unsigned long *)(0xE000E418u))
#define NVIC_IPR7					(*(volatile unsigned long *)(0xE000E41Cu))
/*-------------------reg SYSCFG------------------*/
